...
public class MainActivityCustom extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonScan = (Button) findViewById(R.id.button_scan_c);
        buttonScan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Launch the DeviceListActivity to see devices and do scan
                Intent serverIntent = new Intent(MainActivityCustom.this, DeviceListActivity.class);
        ...
        Button mSendWalletsButton = (Button) findViewById(R.id.button_send_wallets);
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            Activity activity = MainActivityCustom.this;
            switch (msg.what) {
                ...
                case Constants.MESSAGE_READ:
                    ...
                    //MO
                    Gson gson = new Gson();
                    AccountItem accountItem = gson.fromJson(readMessage, AccountItem.class);
